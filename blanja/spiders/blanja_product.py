...
class BlanjaProductSpider(scrapy.Spider):
    name = 'blanja_product'
    ...
    def start_requests(self):
        ...
        for category in session.query(CategoryDB).limit(207).offset(207):
            page_no = 1
...
def parse(self, response):
    ...
    json_products = json.loads(response.css("#gtm-param").xpath('@value').extract_first())
